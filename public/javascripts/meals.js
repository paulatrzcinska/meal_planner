function addRow() {
	$(".table").find('tbody')
    .append($('<tr>')
        .append($('<td id="productName" style="min-widtht: 160px">')
        	.append($('<input type="text" style="min-width: 160px" list="products" placeholder="Wybierz produkt..." class="form-control">'))
        )
        .append($('<td id="mealWeight">')
        	.append($('<input type="number" name="mealWeight" class="form-control" onchange="calculate(this)">'))
        )
